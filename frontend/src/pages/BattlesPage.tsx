...
const BATTLES: Battle[] = [
  ...
  },
  {
    ...
    enemyName: 'يهود خيبر',
    result: 'نصر',
    location: 'خيبر، شمال المدينة المنورة',
            ...
            >
              <div className="pt-4 space-y-3">
                ...
                {battle.hadith && (
                  ...
                  >
                    <p className="font-kufi text-xs mb-1.5" style={{ color: 'rgba(201,168,76,0.6)' }}>حديث / قول</p>
...
const BattlesPage: React.FC = () => {
  ...
  const filtered = useMemo(() => {
    return BATTLES.filter(b => {
      ...
      const matchSearch = !q || b.name.includes(q) || b.location.includes(q) || b.significance.includes(q);
